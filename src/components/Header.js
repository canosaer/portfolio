        ...
        <header className="header">
            ...
            <nav className={sidebarStyles}>
                <ul className="menu__list">
                    <li className="menu__item"><a href="#about" onClick={() => menuOpen ? setMenuOpen(!menuOpen) : null} className="menu__link">About Me <div className="menu__bar"></div> </a></li>
                    <li className="menu__item"><a href="#projects" onClick={() => menuOpen ? setMenuOpen(!menuOpen) : null} className="menu__link">Projects <div className="menu__bar"></div> </a></li>
